...
-- Completed direct trades. Items are stored separately under the generated id.
...
-- Immutable RODEX history; unlike mail/mail_attachments it survives retrieval/deletion.
