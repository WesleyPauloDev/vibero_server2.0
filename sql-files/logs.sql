...
--
-- Table structure for table `cashshop_transactions`
--
...
--
-- Table structure for table `refine_log`
--
...
CREATE TABLE IF NOT EXISTS `refine_log` (
  ...
  `blessing_item_id` int(10) unsigned NOT NULL default '0',
  `blessing_amount` smallint(5) unsigned NOT NULL default '0',
  `bound` tinyint(1) unsigned NOT NULL default '0',
  `enchantgrade` tinyint unsigned NOT NULL default '0',
