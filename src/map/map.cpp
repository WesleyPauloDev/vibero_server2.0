...
char vending_transactions_table[32] = "vending_transactions";
...
#undef RENEWALPREFIX
		...
		else if( strcmpi( w1, "vending_transactions_table" ) == 0 )
			safestrncpy(vending_transactions_table, w2, sizeof(vending_transactions_table));
